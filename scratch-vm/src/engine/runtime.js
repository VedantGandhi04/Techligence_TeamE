...
const BlocksRuntimeCache = require("./blocks-runtime-cache.js");
const BlockType = require("../extension-support/block-type.js");
const Profiler = require("./profiler.js");
const Sequencer = require("./sequencer.js");
const execute = require("./execute.js");
const ScratchBlocksConstants = require("./scratch-blocks-constants.js");
const TargetType = require("../extension-support/target-type.js");
const Thread = require("./thread.js");
const log = require("../util/log.js");
const maybeFormatMessage = require("../util/maybe-format-message.js");
const StageLayering = require("./stage-layering.js");
const Variable = require("./variable.js");
const xmlEscape = require("../util/xml-escape.js");
const ScratchLinkWebSocket = require("../util/scratch-link-websocket.js");
const fetchWithTimeout = require("../util/fetch-with-timeout.js");

// Virtual I/O devices.
const Clock = require("../io/clock.js");
const Cloud = require("../io/cloud.js");
const Keyboard = require("../io/keyboard.js");
const Mouse = require("../io/mouse.js");
const MouseWheel = require("../io/mouseWheel.js");
const UserData = require("../io/userData.js");
const Video = require("../io/video.js");

const StringUtil = require("../util/string-util.js");
const uid = require("../util/uid.js");

const defaultBlockPackages = {
    scratch3_control: require("../blocks/scratch3_control.js"),
    scratch3_event: require("../blocks/scratch3_event.js"),
    scratch3_looks: require("../blocks/scratch3_looks.js"),
    scratch3_motion: require("../blocks/scratch3_motion.js"),
    scratch3_operators: require("../blocks/scratch3_operators.js"),
    scratch3_sound: require("../blocks/scratch3_sound.js"),
    scratch3_sensing: require("../blocks/scratch3_sensing.js"),
    scratch3_data: require("../blocks/scratch3_data.js"),
    scratch3_procedures: require("../blocks/scratch3_procedures.js"),
};
