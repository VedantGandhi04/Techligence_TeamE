...
if (typeof TextEncoder === 'undefined') {
    ...
    _TextEncoder = TextEncoder; //Akshay gan
}
const EventEmitter = require("events");
const JSZip = require("jszip");

const Buffer = require("buffer").Buffer;
const centralDispatch = require("./dispatch/central-dispatch.js");
const ExtensionManager = require("./extension-support/extension-manager.js");
...
const newBlockIds = require("./util/new-block-ids.js");
...
const {
    serializeSounds,
    serializeCostumes,
} = require("./serialization/serialize-assets.js");
...
class VirtualMachine extends EventEmitter {
     ...
     */
    toJSON(optTargetId) {
        const sb3 = require("./serialization/sb3.js");
    ...
    deserializeProject(projectJSON, zip) {
        ...
        const deserializePromise = function () {
            ...
            if (projectVersion === 2) {
                const sb2 = require("./serialization/sb2.js");
